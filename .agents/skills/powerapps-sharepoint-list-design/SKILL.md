---
name: powerapps-sharepoint-list-design
description: Designing SharePoint lists and columns for Power Apps — correct internal names, optional columns, Title column policy, draft-friendly saves, and validation checklists. Use when planning or creating SharePoint lists that will be used as a Power Apps data source.
license: MIT
---
